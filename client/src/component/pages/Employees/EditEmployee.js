...
const EditEmployee = ()=>{
    ...
    const submitEmployee = ()=>{
        ...
        axios.post('http://localhost:5000/api/employee/updateEmployee',updateInfo).then(res=>{
            alert(res.data);
    ...
    return(
        ...
        <Card
            ...
            className="mb-2"
        >
            <Card.Header> <h4 style={{ textAlign: 'left' }}>Edit Employee</h4> </Card.Header>
            <Card.Body>
                <Form>
                    <Row className="mb-3">
                    ...
                    <Button onClick={() => submitEmployee()} className='primary' style={{ position: 'relative', right: '32rem' }}>Update</Button>
