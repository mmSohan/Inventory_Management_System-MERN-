                ...
                <div class="card-body" id="C-body">
                    <form>
                        ...
                        <div class="container form-group">
                            ...
                            <textarea value={address} onChange={(e) => setAddress(e.target.value)} class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Address"></textarea>
                        </div>
                        ...
                        <div style={{ paddingTop: '2rem' }}>
                            <button type="button" className="btn btn-submit p-2" onClick={submitPost}>Submit</button>
                        </div>
